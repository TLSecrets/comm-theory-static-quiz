...
const questionList = [
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第1-2章小测',
    question: '消息中所含信息量的多少与消息的种类无关（ ）。   对         错',
    answer: 'A',
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第1-2章小测',
    question: '高斯白噪声通常是指噪声的功率谱密度服从高斯分布（ ）。    对    错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第1-2章小测',
    question: '通信系统中不管有没有信号，加性噪声是始终存在的（ ）。    对    错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第1-2章小测',
    question: '若矩形脉冲信号的宽度加宽，则它的频谱带宽也加宽（ ）。    对    错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第1-2章小测',
    question: '周期信号的频谱是离散谱，非周期信号的频谱是连续谱   对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'calc',
    chapter: '第1-2章小测',
    question: '已知随机过程  其中A  f0为常数,随机相位θ在[0,2π]内均匀分布， 自相 关函数为  求X(t)的功率谱密度及平均功率。',
    answer: '',
    explanation: '',
    image: ''
  },
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第3章小测',
    question: 'DSB和SSB解调只能采用相干解调（ ）。  对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第3章小测',
    question: 'DSB调制信号的制度增益是SSB的一倍，所以其抗噪声性能比SSB好一倍（ ）。  对         错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第4-5章小测',
    question: '理论上无限长的横向均衡器可以完全消除抽样时刻上的码间串扰（ ）。    对    错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第4-5章小测',
    question: '当脉冲宽度相同时 ,升余弦脉冲信号的带宽是矩形脉冲信号带宽的2倍。    对    错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第4-5章小测',
    question: 'AM的解调即可以采用包络解调 ,也可以采用相干解调。   对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第4-5章小测',
    question: '数字基带信号的功率谱形状仅取决于数字基带信号的码型。   对         错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第4-5章小测',
    question: '数字基带信号的功率谱形状仅取决于数字基带信号的波形   对         错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第4-5章小测',
    question: '双极性数字基带信号功率谱的第一个零点频率是矩形波宽度的倒数。   对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  ...
  },
  {
    ...
    type: 'single',
    chapter: '第6-8章小测',
    question: '对于2PSK采用直接法载波同步会带来载波相位模糊是（ ）。    90∘和180∘不定',
    options: [
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: 'MQAM和MPSK具有相同的频带利用率   对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: 'QPSK调制方式中当信码从00变为11时，或者从11变为00时，其相位跳变均为180度。   对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  ...
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '增量调制系统中如果量化台阶选大有利于减小过载噪声 ，但一般量化噪声增大。    对    错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '增量调制系统中减小过载噪声的方法之一是选择大的抽样速率fs    对    错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '均匀量化时量化噪声功率N q大小与信号样值大小无关，仅与量化间隔   V 有关。    对    错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '如果信噪比r一定，相同调制方式时有    对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '多进制数字调制随着M增大，相邻信号点的距离会逐渐减小，抗噪声性能会下降。   对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: 'QPSK调制方式中载波相位与基带信号双比特的关系是唯一的。     对   错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '2ASK、2PSK、2FSK频带信号的带宽都是其数字基带调制信号带宽的两倍（ ）。    对    错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '量化时采用的量化台阶数越多其量化信噪比就越小。    对    错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '4DPSK解调器既可以采用相干解调+码反变换，也可以采用差分相干解调。  对         错',
    answer: 'A',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: '2DPSK解调器可以采用差分相干解调，但4DPSK不可以采用差分相干解调。   对         错',
    answer: 'B',
    explanation: '',
    image: ''
  },
  {
    ...
    type: 'judge',
    chapter: '第6-8章小测',
    question: 'QPSK调制方式中当信码从01变为10时，其相位跳变90度。     对   错',
    answer: 'B',
    explanation: '',
    image: ''
  },
...
// 首次加载时缓存到localStorage
(function() {
  try {
    if (!localStorage.getItem('csp_cache')) {
